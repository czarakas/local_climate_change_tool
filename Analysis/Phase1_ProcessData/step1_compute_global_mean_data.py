"""
This module generates datasets of global means for each of the processed CMIP6
zarr files. Modified from step1_process_climate_model_data.py.
...
OUT_DIR = INTERMEDIATE_DIR + 'GlobalMeanData/'
...
PROCESSED_DICT = read_zarr_files(INTERMEDIATE_DIR)
